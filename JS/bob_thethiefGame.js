...
window.setInterval(autoMove, 100)
...
function collectCoin(){
  if(coin != 5)
  {
    if(theif.xposition == 30 && theif.yposition == 18 && coinsFlag[0]==1 )
    {
      coinsFlag[0]=0;
      coin++;
   ...
   // second floor
   else if(theif.xposition == 3  && theif.yposition == 11 && coinsFlag[1]==1)
    {
      coinsFlag[1]=0;
    ...
    else if(theif.xposition == -8  && theif.yposition == -3.7 && coinsFlag[3]==1)
   {
    ...
    else if(theif.xposition == 27 && theif.yposition == -11.1 && coinsFlag[4]==1)
    {
      coinsFlag[4]=0;
      coin++;
