...
resize(520,600,"coinDiv1")
resize(410,800,"coinDiv2")
resize(140,750,"coinDiv3")
resize(240,520,"coinDiv4")
resize(310,1050,"coinDiv5")
...
function spaceKeyPressed(){
  if(coin != 5)
  {
    ...
    if(theif.xposition == 6 && theif.yposition == 18 && coinsFlag[0]==1 )
    {
      coinsFlag[0]=0;
      coin++;
   ...
   // second floor
   else if(theif.xposition == -9  && theif.yposition == 11 && coinsFlag[1]==1)
    {
      coinsFlag[1]=0;
    ...
    //Third Floor
   else if(theif.xposition == -29 && theif.yposition == 3.5 && coinsFlag[2]==1)
   {
    coinsFlag[2]=0;
   ...
   //Fourth Floor
    else if(theif.xposition == 12  && theif.yposition == -3.7 && coinsFlag[3]==1)
   {
      coinsFlag[3]=0;
      coin++;
    ...
    else if(theif.xposition == -6 && theif.yposition == -11.1 && coinsFlag[4]==1)
    {
      coinsFlag[4]=0;
      coin++;
