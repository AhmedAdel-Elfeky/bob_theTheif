...
resize(520,600, "coinDiv6")
resize(410,800, "coinDiv7")
resize(140,750, "coinDiv8")
resize(240,520, "coinDiv9")
resize(310,1050,"coinDiv10")
...
function spaceKeyPressed(){
  if(coin != 10)
  {
    ...
    else if(theif.xposition == 6 && theif.yposition == 18 && coinsFlag[5]==1 )
    {
      coinsFlag[5]=0;
      coin++;
      CoinDiv[5].style.display = "inline"
      mySound.play();
    }
   ...
   // second floor
    ...
    {
      coinsFlag[6]=0;
      CoinDiv[6].style.display = "inline"
      coin++;
      mySound.play();
    }
   ...
   {
    coinsFlag[9]=0;
     CoinDiv[9].style.display = "inline"
     coin++;
     mySound.play();
   }
   //Fourth Floor
   ...
   else if(theif.xposition == 12  && theif.yposition == -3.7 && coinsFlag[8]==1)
   {
      coinsFlag[8]=0;
      coin++;
      CoinDiv[8].style.display = "inline"
      mySound.play();
   }
/********fifth floor */
    ...
    else if(theif.xposition == -6 && theif.yposition == -11.1 && coinsFlag[7]==1)
    {
      coinsFlag[7]=0;
      coin++;
      CoinDiv[7].style.display = "inline"
      mySound.play();
    }
