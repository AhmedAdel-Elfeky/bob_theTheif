...
function spaceKeyPressed() {
  if (coin != 5) {
    ...
    if (theif.xposition == -2 && theif.yposition == 18 && coinsFlag[0] == 1) {
      coinsFlag[0] = 0;
      coin++;
    ...
    // second floor
    else if (theif.xposition == 17 && theif.yposition == 11 && coinsFlag[1] == 1) {
      coinsFlag[1] = 0;
    ...
    //Third Floor
    else if (theif.xposition == -15 && theif.yposition == 3.5 && coinsFlag[2] == 1) {
      coinsFlag[2] = 0;
    ...
    //Fourth Floor
    else if (theif.xposition == 11 && theif.yposition == -3.7 && coinsFlag[3] == 1) {
      coinsFlag[3] = 0;
      coin++;
    ...
    else if (theif.xposition == 4 && theif.yposition == -11.1 && coinsFlag[4] == 1) {
      coinsFlag[4] = 0;
      coin++;
